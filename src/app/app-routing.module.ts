...
const routes: Routes = [
  ...
  { path: 'compte/:userId/:uuId', component: CompteVendorComponent },
  { path: 'messages', component: MessageComponent },
  {
    path: 'conditions_generales_de_ventes',
    component: ConditionsGeneralesComponent,
  },
  { path: 'favoris', component: FavoisComponent, canActivate: [AuthGuard] },
  {
  ...
  { path: 'annonce_in_progress', component: MessageAddAnnonceComponent },
  {
