...
export class OptionAdsComponent implements OnInit {
  ...
  deleteFormDataFromLocalStorage() {
    localStorage.removeItem('formData');
    localStorage.removeItem('settings');
    localStorage.removeItem('selectedOption');
    localStorage.removeItem('selectedSubcategory');
    localStorage.removeItem('selectedPaidOptionId');
    localStorage.removeItem('promoteOptions');
    localStorage.removeItem('selectedPaidOption');
    localStorage.removeItem('selectedOptions');
    console.log('Deleted the form data from localStorage');
  }
